...
<nav class="nav">
    <ul class="nav__list">
        ...
        <li class="nav__item  nav__item--arrow1">
            <a href="comic.php?p_id=<?= $comicNav->indexPrevComic(); ?>"  class="nav__link">
        ...
        <li class="nav__item nav__item--disabled nav__item--arrow2">
            <p class="nav__link">
                <img src="images/icons/prepped/next.png" class="nav__img arrow-icon" alt="Disabled Link to Next Comic">
                Next
            </p>
        </li>
        ...
        <li class="nav__item nav__item--disabled nav__item--hand2">
            <p class="nav__link">
                <img src="images/icons/prepped/last.png" class="nav__img hand-icon" alt="Disabled Link to Newest Comic">
                Last
            </p>
        </li>
